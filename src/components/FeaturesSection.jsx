...
const FeatureCard = ({ title, desc, icon }) => {
  return (
    ...
    >
      <div
        className="absolute -left-[55%] -bottom-[55%] w-[170%] h-[170%] rounded-full bg-[#034EA2]
      ...
      <div className="relative z-10 h-full p-7 flex flex-col justify-between transition-opacity duration-300 ease-out group-hover:opacity-0">
        <h3 className="text-[#034EA2] font-semibold text-[22px] leading-7">
          {title}
        </h3>

        <div className="flex items-center justify-between">
          <span className="text-[#034EA2] text-sm font-medium">Read More</span>
          <div className="w-10 h-10 rounded-full bg-[#EEF2F7] flex items-center justify-center text-[#034EA2]">
      ...
      >
        <div className="h-[46px] flex items-start">
          {icon ? (
            ...
            <div className="w-[44px] h-[44px] rounded-full border border-white/25" />
          )}
        </div>
    ...
    >
      ...
      <button
        className="w-full h-[52px] rounded-[14px]
                   border border-[#034EA2] text-[#034EA2]
                   px-5 font-medium text-[14px]
                   flex items-center justify-between
                   transition duration-300 hover:bg-[#034EA2] hover:text-white"
      >
